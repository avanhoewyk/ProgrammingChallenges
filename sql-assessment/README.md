...
1. Write a query to get the sum of impressions by day.
  ...
  SELECT SUM (impressions) FROM marketing_performance ; 
  
3. Write a query to get the top three revenue-generating states in order of best to worst. How much revenue did the third best state generate?
